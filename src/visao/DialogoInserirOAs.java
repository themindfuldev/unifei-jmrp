...
public class DialogoInserirOAs extends JDialog
{
   ...
   private ControleInsercaoDeOAs controle;
   ...
   public DialogoInserirOAs(ControleInsercaoDeOAs controle, Dialog owner)
	{
		super(owner, true);
   ...
   {
		int escolha = JOptionPane.showConfirmDialog(null, "Confirma inserção destas OAs?",
				"Confimação", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
   	if (escolha == 0)
   	{
