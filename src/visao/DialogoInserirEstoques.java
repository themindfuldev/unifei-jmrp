...
public class DialogoInserirEstoques extends JDialog
{
	...
	private ControleInsercaoDeEstoques controle;
	...
	public DialogoInserirEstoques(ControleInsercaoDeEstoques controle, Dialog owner)
	{
		super(owner, true);
	...
	private void initComponents()
	{
		...
		TableModel mdlTabela = new JMRPTableModel(new String[] { "Material",
				"Estoque atual", "Estoque alocado" }, itens, true);
	...
	{
		int escolha = JOptionPane.showConfirmDialog(null, "Confirma inserção destes estoques?",
				"Confimação", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
   	if (escolha == 0)
   	{
